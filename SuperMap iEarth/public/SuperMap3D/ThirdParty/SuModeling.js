...
if (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER) {
  ...
  // blob urls look like blob and we cannot infer anything from them.
...
// Indicates whether filename is delivered via file protocol
...
var wasmBinaryFile;
  wasmBinaryFile = 'SuModeling.wasm';
...
function createWasm() {
  ...
  function receiveInstantiationResult(result) {
    ...
    trueModule = null;
    // TODO: Due to Closure regression the above line no longer optimizes out down to the following line.
...
var ASM_CONSTS = {
  ...
  var dlopenMissingError =  'To use dlopen, you need enable dynamic linking';
...
/** @type {function(...*):?} */
var _GeoSphere = Module["_GeoSphere"] = createExportWrapper("GeoSphere");

/** @type {function(...*):?} */
var _GeoHemiSphere = Module["_GeoHemiSphere"] = createExportWrapper("GeoHemiSphere");

/** @type {function(...*):?} */
var _GeoBox = Module["_GeoBox"] = createExportWrapper("GeoBox");

/** @type {function(...*):?} */
var _GeoCylinder = Module["_GeoCylinder"] = createExportWrapper("GeoCylinder");

/** @type {function(...*):?} */
var _GeoCone = Module["_GeoCone"] = createExportWrapper("GeoCone");

/** @type {function(...*):?} */
var _GeoPyramid = Module["_GeoPyramid"] = createExportWrapper("GeoPyramid");

/** @type {function(...*):?} */
var _GeoCircle3D = Module["_GeoCircle3D"] = createExportWrapper("GeoCircle3D");

/** @type {function(...*):?} */
var _GeoEllipsoid = Module["_GeoEllipsoid"] = createExportWrapper("GeoEllipsoid");

/** @type {function(...*):?} */
var _GeoTorus = Module["_GeoTorus"] = createExportWrapper("GeoTorus");

/** @type {function(...*):?} */
var _GeoEllipticRing = Module["_GeoEllipticRing"] = createExportWrapper("GeoEllipticRing");

/** @type {function(...*):?} */
var _GeoRectangularRing = Module["_GeoRectangularRing"] = createExportWrapper("GeoRectangularRing");

/** @type {function(...*):?} */
var _GeoTruncatedCone = Module["_GeoTruncatedCone"] = createExportWrapper("GeoTruncatedCone");

/** @type {function(...*):?} */
var _GeoTable3D = Module["_GeoTable3D"] = createExportWrapper("GeoTable3D");

/** @type {function(...*):?} */
var _GeoWedge = Module["_GeoWedge"] = createExportWrapper("GeoWedge");

/** @type {function(...*):?} */
var _GeoBendingCylinder = Module["_GeoBendingCylinder"] = createExportWrapper("GeoBendingCylinder");

/** @type {function(...*):?} */
var _linearExtrude = Module["_linearExtrude"] = createExportWrapper("linearExtrude");

/** @type {function(...*):?} */
var _rotateExtrude = Module["_rotateExtrude"] = createExportWrapper("rotateExtrude");

/** @type {function(...*):?} */
var _loft = Module["_loft"] = createExportWrapper("loft");
