    ...
    */
    startProfile(_positions) {
        ...
        for (let i = 1, j = _positions.length; i < j; i++) {
            ...
            let dis = Cesium.Cartesian3.distance(startPoint, endPoint)
    ...
    addLine(positions) {
        ...
        this.viewer.entities.add({
            ...
            polyline: {
                ...
                positions: positions,
                width: 5,
                material: Cesium.Color.fromCssColorString("rgb(250, 213, 6)"),
     ...
     */
    addEntity(positions) {
        if (this.entity || !Cesium.defined(this.entityUrl)) return;
