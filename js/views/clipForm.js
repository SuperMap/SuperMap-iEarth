            ...
            <section id="clipContent1" class="params-window-content">
                <div class="ui raised segment" style="margin: 10px; background: #3b4547">
                    <div>
                        ...
                        <p><span>` + Resource.length + `</span><input type="number" id="box-clip-length" class="input clip-input" min="0" step="1"
                                                  value="10"><span>&nbsp;米</span></p>
                        <p><span>` + Resource.width + `</span><input type="number" id="box-clip-width" class="input clip-input" min="0" step="1"
                                                  value="10"><span>&nbsp;米</span></p>
                        <p><span>` + Resource.height + `</span><input type="number" id="box-clip-height" class="input clip-input" min="0" step="1"
                                                  value="10"><span>&nbsp;米</span></p>
                        <p><span>` + Resource.rotate + `</span><input type="number" id="box-clip-rotate" class="input clip-input" min="0" max="360" step="1"
                        ...
                        <select id="box-clip-mode" class="cesium-button" style="font-size: 12px;margin: 0px 0px -5px 0px;width: 90%">
                            ...
                            <option value="clip_behind_all_plane_without_line_frame">` + Resource.CutInsideBoxNOFrame + `</option>
            ...
            <section id="clipContent2">
                <div class="adaptation">
                    <div class="ui raised segment" style="margin: 10px; background: #3b4547 ">
                        ...
                        <p><span>` + Resource.Spacelongitude + `</span><input type="number" id="plane-clip-point1-longitude" class="input clip-input"
                                                  min="-180" max="180" step="0.0001" value="0" size="5"><span>&nbsp;度</span></p>
                        <p><span>` + Resource.Spacelatitude + `</span><input type="number" id="plane-clip-point1-latitude" class="input clip-input"
                                                  min="-180" max="180" step="0.0001" value="0" size="5"><span>&nbsp;度</span></p>
                        <p><span>` + Resource.Spacealtitude + `</span><input type="number" id="plane-clip-point1-height" class="input clip-input" step="1"
                                                  value="0" size="5"><span>&nbsp;米</span></p>
                        <a class="ui teal ribbon label clip-label">` + Resource.secondPoint + `</a>
                        <p><span>` + Resource.Spacelongitude + `</span><input type="number" id="plane-clip-point2-longitude" class="input clip-input"
                                                  min="-180" max="180" step="0.0001" value="0" size="5"><span>&nbsp;度</span></p>
                        <p><span>` + Resource.Spacelatitude + `</span><input type="number" id="plane-clip-point2-latitude" class="input clip-input"
                                                  min="-180" max="180" step="0.0001" value="0" size="5"><span>&nbsp;度</span></p>
                        <p><span>` + Resource.Spacealtitude + `</span><input type="number" id="plane-clip-point2-height" class="input clip-input" step="1"
                                                  value="0" size="5"><span>&nbsp;米</span></p>
                        <a class="ui green ribbon label">` + Resource.thirdPoint + `</a>
                        <p><span>` + Resource.Spacelongitude + `</span><input type="number" id="plane-clip-point3-longitude" class="input clip-input"
                                                  min="-180" max="180" step="0.0001" value="0" size="5"><span>&nbsp;度</span></p>
                        <p><span>` + Resource.Spacelatitude + `</span><input type="number" id="plane-clip-point3-latitude" class="input clip-input"
                                                  min="-180" max="180" step="0.0001" value="0" size="5"><span>&nbsp;度</span></p>
                        <p><span>` + Resource.Spacealtitude + `</span><input type="number" id="plane-clip-point3-height" class="input clip-input" step="1"
                                                  value="0" size="5"><span>&nbsp;米</span></p>
