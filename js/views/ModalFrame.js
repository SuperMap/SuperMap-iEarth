    ...
    var htmlStr = `
        <div class="myModal-content">
            <div class="myModal-header">
                <button type="button" aria-label="Close" class="myModal-close" title=${Resource.close}  id="btnCloseModal"><span
                        aria-hidden="true">&times;</span></button>
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" id="servicePan" class="active"><a href="#webServicePan" aria-controls="home"
                                                                              role="tab" data-toggle="tab">${Resource.smOnlineService}</a>
                    </li>
                    <li role="presentation"><a href="#customServicePan" aria-controls="home" role="tab" data-toggle="tab">${Resource.customService}</a>
                    </li>
