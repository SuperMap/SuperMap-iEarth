    ...
    var htmlStr = [
       "<div class='btn-toolbar'>",
           "<div class='btn-group' style='margin: 5px 5px 5px 8px;'>",
               "<a id='measureDisBtn' title='" + Resource.measureDis + "' class='btn btn-inverse' style='margin : 5px;'><span class='iconfont icon-iEarth-R-xiugai_liangsuan-1'></span></a>",
               "<a id='measureAreaBtn'  title='" + Resource.measureArea + "' class='btn btn-inverse' style='margin : 5px;'><span class='iconfont icon-iEarth-R-xiugai_liangsuan-2'></span></a>",
               "<a id='measureHeightBtn'  title='" + Resource.measureHeight + "' class='btn btn-inverse' style='margin : 5px;'><span class='iconfont icon-iEarth-R-xiugai_liangsuan-'></span></a>",
