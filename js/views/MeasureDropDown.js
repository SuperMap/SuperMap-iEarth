define(['./Container','Cesium','../tools/Area'],function(Container,Cesium,Area){
    ...
    var htmlStr = [
       ...
       "</div>",
        /*'<div>',
            "<div class='measure-title' style='float:left;font-size: 12px'>" + Resource.pattern + "</div>",
            '<select id="selOpt" class="cesium-button" style="font-size: 12px;margin-left: -15px">',
                '<option value="1">'+ Resource.spatialMeasuring +'</option>',
                '<option value="2">'+ Resource.StickMeasurement +'</option>',
            '</select>',
        '</div>',*/
