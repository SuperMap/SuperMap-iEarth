define([
    ...
    var htmlStr = [
                   ...
                   "<a data-toggle='dropdown' id='layerMangerBtn' title='" + Resource.layerManager + "' class='btn btn-inverse'><span style='font-size : 17px;' class='iconfont icon-tuceng' ></span></a>",
                   ...
                   "<a class='btn btn-inverse' style='padding : 10px 0px;'><span style='border-left : 1px solid #dddddd;'></span></a>",
                   "<a data-toggle='dropdown' id='clipBtn' title='" + "裁剪" + "' class='btn btn-inverse'><span class='iconfont icon-ai50'></span></a>",
                   "<a data-toggle='dropdown' id='terrainBtn' title='" + "地形" + "' class='btn btn-inverse'><span class='iconfont icon-1'></span></a>",
                  ...
                  "<a class='btn btn-inverse' style='padding : 10px 0px;'><span style='border-left : 1px solid #dddddd;'></span></a>",
                   "<a id='addMarkerBtn' title='" + "在线编辑" + "' class='btn btn-inverse'><span class='iconfont icon-edit'></span></a>",
                   "<a data-toggle='dropdown' id='propertyBtn' title='" + "空间查询" + "' class='btn btn-inverse'><span class='iconfont icon-zhcc_chaxun'></span></a>",
