define([
    ...
    var htmlStr = [
                   ...
                   "<a data-toggle='dropdown' id='layerMangerBtn' title='" + Resource.layerManager + "' class='btn btn-inverse'><span class='iconfont icon-tuceng'></span></a>",
                   "<a class='btn btn-inverse' style='padding : 10px 0px;'><span style='border-left : 1px solid #dddddd;'></span></a>",
                   "<a id='expandBtn' style='display : none;' title='" + Resource.expand + "' class='btn btn-inverse'><span class='iconfont icon-shouqi-right'></span></a>",
                   ...
                   "<a data-toggle='dropdown' id='baseLayerBtn' title='" + Resource.setBaseLayer + "' class='btn btn-inverse' ><span class='iconfont icon-ditu'></span></a>",
                   "<a data-toggle='dropdown' id='settingBtn'  title='" + "场景" + "' class='btn btn-inverse'><span class='iconfont icon-shezhi'></span></a>",
                   "<a class='btn btn-inverse' style='padding : 10px 0px;'><span style='border-left : 1px solid #dddddd;'></span></a>",
                   "<a data-toggle='dropdown' id='clipBtn' title='" + "剖切裁剪" + "' class='btn btn-inverse'><span class='iconfont icon-caijian'></span></a>",
                   "<a data-toggle='dropdown' id='analysisBtn'  title='" + Resource.analysis + "' class='btn btn-inverse'><span class='iconfont icon-fenxi1'></span></a>",
                   "<a data-toggle='dropdown' id='measureBtn' title='" + "量算" + "' class='btn btn-inverse'><span class='iconfont icon-celiang'></span></a>",
                   "<a data-toggle='dropdown' id='terrainBtn' title='" + "地形" + "' class='btn btn-inverse'><span class='iconfont icon-mountain'></span></a>",
                   /*"<a data-toggle='dropdown' id='bookmarkBtn' title='" + "书签" + "' class='btn btn-inverse'><span class='smicon-bookmark '></span></a>",*/
                   "<a class='btn btn-inverse' style='padding : 10px 0px;'><span style='border-left : 1px solid #dddddd;'></span></a>",
                   "<a id='addMarkerBtn' title='" + "在线编辑" + "' class='btn btn-inverse'><span class='iconfont icon-bianji'></span></a>",
                   "<a data-toggle='dropdown' id='propertyBtn' title='" + "空间查询" + "' class='btn btn-inverse'><span class='iconfont icon-query1'></span></a>",
                   "<a id='foldBtn' title='" + Resource.fold + "' class='btn btn-inverse'><span class='iconfont icon-shouqi-left-copy'></span></a>",
                   "</div>",
                   "</div>"
                   ].join('');
