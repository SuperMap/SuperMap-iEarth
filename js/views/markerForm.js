define(['./Container',
        ...
        '<section id="objectContent2">',
            '<div class="function-module-content">',
                '<div class="function-module-sub-section">',
                    '<label class="function-module-sub-section-caption">' + Resource.symbolicLibrary + '</label>',
                    '<div class="mark-list">',
                        '<div id="fullLine" class="mark-list-item"><a class="iconfont icon-line"></a><label>' + Resource.fulline + '</label></div>',
                        '<div id="dottedLine" class="mark-list-item"><a class="iconfont icon-xuxian"></a><label>' + Resource.Virtuallinear + '</label></div>',
                        '<div id="outline" class="mark-list-item"><a class="iconfont icon-xiantiao"></a><label>' + Resource.contourline + '</label></div>',
                        '<div id="arrowLine" class="mark-list-item"><a class="iconfont icon-line-arrow"></a><label>' + Resource.arrowline + '</label></div>',
                        '<div id="glowLine" class="mark-list-item"><a class="iconfont icon-xiancai5"></a><label>' + Resource.Haloline + '</label></div>',
                        '<div id="TrailLine" class="mark-list-item"><a class="iconfont icon-yuanxuxian"></a><label>' + Resource.Wakeline + '</label></div>',
                    '</div>',
                '</div>',
                '<div class="function-module-sub-section">',
                    '<div class="half">',
        ...
        '<section id="objectContent3">',
            '<div class="function-module-content">',
                '<div class="function-module-sub-section">',
                    '<label class="function-module-sub-section-caption">' + Resource.symbolicLibrary + '</label>',
                    '<div class="mark-list">',
                        '<div id="pureColor" class="mark-list-item"><a class="iconfont icon-lansekuangicon"></a><label>' + Resource.pureColor + '</label></div>',
                        '<div id="gridding" class="mark-list-item"><a class="iconfont icon-plus-gridview"></a><label>' + Resource.gridding + '</label></div>',
                        '<div id="stripe" class="mark-list-item"><a class="iconfont icon-ic_texture_px"></a><label>' + Resource.stripe + '</label></div>',
                    '</div>',
                '</div>',
                '<div>',
    ...
    var markerForm = Container.extend({
        ...
        initialize: function (options) {
            ...
            Cesium.loadJson(Window.iportalAppsRoot + '/static/iearth/' + 'data/models.json').then(function (data) {
