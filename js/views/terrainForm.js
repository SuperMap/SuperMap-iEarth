define(['./Container',
    ...
    var htmlStr = [
        ...
        '<section id="terrainContent1">',
            '<div class="ui raised segment" style="margin: 10px; background: #3b4547 ">',
                '<div style="margin: 1rem 0;">',
                    '<a class="ui blue ribbon label">地形修改</a>',
                ...
                '<div>',
                    ...
                    '<label style="font-size:13px;margin-top: 0.5rem;">开挖深度(米):</label>',
                    '<div style="overflow: hidden;position:relative;">',
                        '<input id="depth" class="inputLine form-control" value="1000" required="required" style="position:absolute;bottom:0;"/>',
                        '<div style="float:right;">',
                            '<button class="btn btn-info" id="excavationTerrain">' + "分析" + '</button>',
                            '<button class="btn btn-info" id="excavationTerrainDel">' + "清除" + '</button>',
                        '</div>',
                    '</div>',
                '</div>',
            '</div>',
        ...
        '<div class="ui raised segment" style="margin: 10px; background: #3b4547 ">',
            ...
            '<select id="calMode" class="cesium-button" style="font-size: 12px;width: 90%;margin: 0.5rem 0;">',
    ...
    '</section>',
        ...
        '<a class="ui teal ribbon label" style="margin: 0.5rem 0;">显示模式</a><br>',
