define(['./Container',
    ...
    var htmlStr = [
        ...
        '<div class="ui raised segment" style="margin: 10px; background: #3b4547 ">',
            '<div>',
             '<a class="ui blue ribbon label">地形修改</a><br><br>',
              '<button class="btn btn-info" id="modifyTerrainDel" style="float: right">'+ "清理" +'</button>',
          ...
          '<div>',
             ...
             '<button class="btn btn-info" id="excavationTerrainDel" style="float: right">'+ "清理" +'</button>',
        ...
        '<div class="ui raised segment" style="margin: 10px; background: #3b4547 ">',
           ...
           '<label>'+"(坡度坡向分析需要带法线地形图)" +'</label>',
            '<button type="button" id="terrainSlopeDel" class="btn btn-info" style="float: right">'+ "清理" +'</button>',
    ...
    '</section>',
        ...
        '<a class="ui blue ribbon label">参数设置</a><br>',
           '<label  style="font-size:13px">最大可见高程:</label>',
           '<input type="number" id="maxFloodHeight" class="input" value="9000" required="required"/>',
           '<label  style="font-size:13px">最小可见高程:</label>',
        ...
        '<a class="ui teal ribbon label">播放设置</a><br>',
           '<label  style="font-size:13px">当前高程:</label>',
           ...
           '<button type="button" id="floodDel" class="btn btn-info" style="float: right">'+ "清理" +'</button>',
        ...
        '</select>',
        '<button type="button" id="fillDel" class="btn btn-info" style="float: right">'+ "清理" +'</button>',
