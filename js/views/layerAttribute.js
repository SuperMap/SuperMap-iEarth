define(['./Container','spectrum','drag','slider'],function(Container,spectrum,drag,slider){
    ...
    var htmlStr = `
        <div class="tabs-vertical mainView" id="layerForm"
             style="position: absolute;width:380px;z-index: 1;cursor: auto; display:none">
            ...
            <button aria-label="Close" id="layerClose" class="myModal-close" title=${Resource.close}
                    style="top: 10px;position: absolute;left: 90%;"><span aria-hidden="true">×</span></button>
            <ul>
                ...
                <li><a data-index="3" href="#">图层操作</a></li>
            </ul>
            <div class="tabs-content-placeholder" style="height:350px" id="layer-placeholder">
                <div class="tab-content-active layer-attribute-panel">
                    ...
                    <div class="square-checkbox"><input type="checkbox" id="display" checked/><label
                            for="display">${Resource.display}</label></div>
                    <div class="square-checkbox"><input type="checkbox" id="multiChoose" checked/><label for="multiChoose">${Resource.multiSelection}</label>
                    </div>
                    <div class="square-checkbox"><input type="checkbox" id="cullEnabled"/><label for="cullEnabled">${Resource.cullEnabled}</label>
                    </div>
                    <div class="square-checkbox"><input type="checkbox" id="breleaseColor" checked/><label
                             for="breleaseColor">${Resource.bReleaseColor}</label></div>
                </div>
                <div class="layer-attribute-panel">
                    ...
                    <div class="square-radio" style="display:block;" id="choosenDisplay"><input type="radio" name="choosenDisHidd"><label>${Resource.onlyShowSlection}</label>
                    </div>
                    <div class="square-radio" style="display:block;" id="chooseHidden"><input type="radio" name="choosenDisHidd"><label>${Resource.onlyHideSlection}</label>
                    </div>
                    <div class="square-radio" style="display:block;" id="initialize"><input type="radio"
                                                               name="choosenDisHidd"><label>${Resource.showAll}</label></div>
                </div>
                <div class="layer-attribute-panel">
                ...
                <div class="layer-attribute-panel">
                    ...
                    <div class="square"><input type="checkbox" id="undergroundMode" checked/><label for="display">开启地下</label>
                    </div>
                    <label>地下深度(米)</label>
