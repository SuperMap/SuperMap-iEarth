define(['./Container','spectrum','drag','slider'],function(Container,spectrum,drag,slider){
    ...
    var htmlStr = [
        ...
        '<input id="layer-attribute-visibility" type="radio" name="layer-attribute-tab"/>',
        '<label for="layer-attribute-visibility" class="function-module-caption">' + Resource.visibility + '</label>',
        ...
        '<section id="layer-attribute-basic-content">',
            '<div class="function-module-content">',
                ...
                '</div>',
                '<div class="function-module-sub-section">',
                    '<label class="function-module-sub-section-caption">'+ Resource.shadowMode +'</label>',
                ...
                '<div class="function-module-sub-section">',
                    ...
                    '</div>',
                '</div>',
                '<div class="function-module-sub-section" style="overflow: hidden;">',
        ...
        '<section id="layer-attribute-visibility-content">',
            '<div class="function-module-content">',
                '<div class="function-module-sub-section">',
                    '<div class="half">',
                        '<label class="function-module-sub-section-caption">'+ Resource.visibleDistanceMin +'</label>',
                        '<input type="number" class="input" id="min-visible-height"><span>' + Resource.mUnit + '</span>',
                    '</div>',
                    '<div class="half">',
                        '<label class="function-module-sub-section-caption">'+ Resource.visibleDistanceMax +'</label>',
                        '<input type="number" class="input" id="max-visible-height"><span>' + Resource.mUnit + '</span>',
                    '</div>',
                '</div>',
                '<div class="function-module-sub-section">',
                    '<div class="half">',
                        '<label class="function-module-sub-section-caption">'+ Resource.selectColorType +'</label>',
                        '<select id="colorStyle" class="input" class="selectpicker show-tick form-control" >',
                            '<option value="0" selected>'+ Resource.mix +'</option>',
                            '<option value="1">'+ Resource.replace +'</option>',
                        '</select>',
                    '</div>',
                    '<div class="half">',
                        '<label class="function-module-sub-section-caption">'+ Resource.selectColor +'</label>',
        ...
        '<section id="layer-attribute-style-content">',
            '<div class="function-module-content">',
                ...
                '<div class="function-module-sub-section">',
                    ...
                    '<select id="fillStyle" class="input" class="selectpicker show-tick form-control">',
        ...
        '<section id="layer-attribute-operation-content">',
            '<div class="function-module-content">',
                ...
                '</div>',
                '<div class="function-module-sub-section">',
                    '<label class="function-module-sub-section-caption">'+Resource.FillStyleAndWireFrameMode+'</label>',
                    '<div class="function-module-sub-indent-section">',
                        '<label class="function-module-sub-section-caption-indent">' + Resource.FillStyle + '</label>',
                        '<div>',
                            '<label for="layer-fill-mode" class="param-item-second-level">',
                                '<input type="radio" id="layer-fill-mode" name="layer-fill-style" value="fill"/>',
                                '<span>'+Resource.LayerFillMode+'</span>',
                            '</label>',
                        '</div>',
                        '<div>',
                            '<label for="layer-wireframe-mode" class="param-item-second-level">',
                                '<input type="radio" id="layer-wireframe-mode" name="layer-fill-style" value="wireframe"/>',
                                '<span>'+Resource.LayerWireframeMode+'</span>',
                            '</label>',
                        '</div>',
                        '<div>',
                            '<label for="layer-fill-and-wireframe-mode" class="param-item-second-level">',
                                '<input type="radio" id="layer-fill-and-wireframe-mode" name="layer-fill-style" value="fill-and-wireframe"/>',
                                '<span>' + Resource.LayerFillAndWireframeMode + '</span>',
                            '</label>',
                        '</div>',
                    '</div>',
                    '<div class="function-module-sub-indent-section">',
                        '<label class="function-module-sub-section-caption-indent">'+Resource.WireFrameMode+'</label>',
                        '<div>',
                            '<label for="triangle-wireframe-mode" class="param-item-second-level">',
                                '<input type="radio" id="triangle-wireframe-mode" name="layer-wireframe-mode" value="triangle"/>',
                                '<span>'+Resource.TriangleWireframeMode+'</span>',
                            '</label>',
                        '</div>',
                        '<div>',
                            '<label for="quad-wireframe-mode" class="param-item-second-level">' +
                                '<input type="radio" id="quad-wireframe-mode" name="layer-wireframe-mode" value="quad"/>',
                                '<span>'+Resource.QuadWireframeMode+'</span>' +
                            '</label>',
                        '</div>',
                        '<div>',
                            '<label for="sketch-wireframe-mode" class="param-item-second-level">',
                                '<input type="radio" id="sketch-wireframe-mode" name="layer-wireframe-mode" value="sketch"/>',
                                '<span>' + Resource.SketchWireframeMode + '</span>',
                            '</label>' +
                        '</div>',
                    '</div>',
                '</div>',
