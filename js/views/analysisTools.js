define(['./Container','../lib/Semantic/semantic','../lib/knob','../3DGIS/viewshed3D','../3DGIS/skyline','../3DGIS/shadowQuery','../3DGIS/sightline','drag','spectrum','slider','../3DGIS/profile'],function(Container, semantic, knob, viewshed, skyLine, shadow, sgline, drag, spectrum, slider, profile){
  ...
  '<button aria-label="Close" id="closeMain" class="myModal-close" title="关闭"><span aria-hidden="true">×</span></button>',
    ...
    var htmlStr = `
        <main style="position : absolute;" class="mainView">
            <button aria-label="Close" id="closeMain" class="myModal-close" title="关闭"><span aria-hidden="true">×</span>
            </button>
                ...
                <div class="adaptation">
                    <div class="ui raised segment" style="margin: 10px; background: #3b4547 ">
                        ...
                        <div>
                            <div>
                                <label>观察点位置</label>
                                <div class="coord"><label>X</label><input type="number" id="viewX" value="0.0" step="0.0001"/>
                                </div>
                                <div class="coord"><label>Y</label><input type="number" id="viewY" value="0.0" step="0.0001"/>
                                </div>
                                <br><br>
                            ...
                            <div>
                                <label>可视距离(米)</label>
                                <input type="number" id="distance" class="input" min="0" step="1" value="0.0"
                                       title=${Resource.distance}/>
                            </div>
                            <div>
                                <label>方向角(度)</label>
                                <input type="number" id="direction" class="input" min="0" max="360" step="1.0" value="0.0"
                                       title=${Resource.direction}/>
                            </div>
                            <div>
                                <label>俯仰角度(度)</label>
                                <input type="number" id="pitch" class="input" min="-90" max="90" step="1.0" value="0.0"
                                       title=${Resource.roll}/>
                            </div>
                        ...
                        <div>
                            <div>
                                <label>水平视角(度)</label>
                                <input type="number" id="horizonalFov" class="input" min="1" max="120" step="1.0" value="90"
                                       title=${Resource.horizontalFov}/>
                            </div>
                            <div>
                                <label>垂直视角(度)</label>
            ...
            <section id="content2">
                <div class="ui raised segment" style="margin: 10px; background: #3b4547 ">
                    ...
                    <div>
                        <label>底部高程(米)</label>
                        <input id="bottomHeight" class="input" value="20" style="width: 55%"/>
                        <button id="clickQuery" class="btn btn-info" style="margin-top: -5px">点击查询高程</button>
                    </div>
                    <div>
                        <label>拉伸高度(米)</label>
                    ...
                    <button type="button" class="btn btn-info" id="shadowAnalysis" style="float: right">
            ...
            <section id="content3">
                <div class="ui raised segment" style="margin: 10px; background: #3b4547 ">
                    ...
                    <div>
                        <div class="coord"><label>X</label><input type="number" id="viewPointX" value="0.0" step="0.0001"/>
                        </div>
                        <div class="coord"><label>Y</label><input type="number" id="viewPointY" value="0.0" step="0.0001"/>
                        </div>
                        <br><br>
                        <div class="coord"><label>Z</label><input type="number" id="viewPointZ" value="0.0"/></div>
                        <br><br>
                    </div>
                    <br>
                    ...
                    <div>
                        <div class="square">
                            <label style="width:100%;">${Resource.visibleColor}</label><input class="colorPicker"
                                                                                              data-bind="value: visibleColor,valueUpdate: 'input'"
                                                                                              id="visibleColor"/>
                        </div>
                        <div class="square">
                            <label style="width:100%;">${Resource.hideenColor}</label><input class="colorPicker"
                                                                                             data-bind="value: hiddenColor,valueUpdate: 'input'"
                                                                                             id="hiddenColor"/>
                        </div>
                    </div>
            ...
            <section id="content4">
                <div class="ui raised segment" style="margin: 10px; background: #3b4547 ">
                    ...
                    <div style=" margin-top: 10px; margin-bottom: 10px;">
                        ...
                        <div class="coord"><label>Y</label><input type="number" id="skyviewY" value="0.0" step="0.0001"/></div>
                        <br><br>
                    ...
                    <div class="square">
                        <label style="width:100%; padding-left: 0;">${Resource.skylineColor}</label><input class="colorPicker"
                                                                                                           data-bind="value: skylineColor,valueUpdate: 'input'"
                                                                                                           id="skylineColor"/>
                    </div>
                    <div class="square">
                        <label style="width:100%; padding-left: 0;">${Resource.skylineRadius}</label><input class="input"
                                                                                                            type="number"
                                                                                                            value="1000"
                                                                                                            step="10"
                                                                                                            id="skylineRadius"/>
